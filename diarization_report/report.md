...
<p align="center"><img width="40%" src="pic/input_output.png" /></p>

diarization系统的处理流程大致如下
<p align="center"><img width="40%" src="pic/structure.png" /></p>

其中主要包括segmentation和clustering两个部分：

### Segmentation
<p align="center"><img width="40%" src="pic/segmentation.png" /></p>
...
### Clustering
<p align="center"><img width="40%" src="pic/clustering.png" /></p>
...
<p align="center"><img width="40%" src="pic/classify.png" /></p>
...
<p align="center"><img width="40%" src="pic/AHC.png" /></p>
...
- false alarm (FA)
- speaker error (SE)
<p align="center"><img width="40%" src="pic/der.png" /></p>
...
### PLDA for i-vector
<p align="center"><img width="40%" src="pic/i-vector_plda.png" /></p>
...
<p align="center"><img width="40%" src="pic/der_of_plda_ivector.png" /></p>

### DNN Embedding
<p align="center"><img width="40%" src="pic/embedding_plda.png" /></p>

这个embedding的方法就是对于分割之后的每个segment，用定长的embedding向量来表示，避免了i-vector的计算
<p align="center"><img width="40%" src="pic/dnn_scoring.png" /></p>
...
<p align="center"><img width="40%" src="pic/speaker_embedding.png" /></p>
...
<p align="center"><img width="40%" src="pic/embedding_feature.png" /></p>

上面是所提取的embedding向量的例子，颜色越亮表示数值越高，每个说活人有两段提取的特征，可以每个说话人各自的特征还是有很多相似之处的
在ETAPE数据集上的结果:
<p align="center"><img width="40%" src="pic/der_of_hidden_embedding.png" /></p>

### Cross-show diarization
<p align="center"><img width="40%" src="pic/cross_show.png" /></p>
...
<p align="center"><img width="40%" src="pic/overlapping.png" /></p>
