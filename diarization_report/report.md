...
![Alt text](./der_of_plda_ivector.png)

### DNN Embedding
![Alt text](./embedding_plda.png)

这个embedding的方法就是对于分割之后的每个segment，用定长的embedding向量来表示，避免了i-vector的计算
![Alt text](./dnn_scoring.png)
...
![Alt text](./speaker_embedding.png)
